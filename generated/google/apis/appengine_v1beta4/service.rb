...
module GoogleAPI
  module Apis
    module AppengineV1beta4
      ...
      #
      #    Appengine = GoogleAPI::Apis::AppengineV1beta4 # Alias the module
      ...
      class AppengineService < GoogleAPI::Apis::Core::BaseService
        ...
        # @yieldparam result [GoogleAPI::Apis::AppengineV1beta4::Application] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::AppengineV1beta4::Application]
        #
        ...
        def get_app(apps_id, ensure_resources_exist: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::AppengineV1beta4::Application::Representation
          command.response_class = GoogleAPI::Apis::AppengineV1beta4::Application
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::AppengineV1beta4::Operation] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::AppengineV1beta4::Operation]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def delete_app_module(apps_id, modules_id, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::AppengineV1beta4::Operation::Representation
          command.response_class = GoogleAPI::Apis::AppengineV1beta4::Operation
          command.params['appsId'] = apps_id unless apps_id.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::AppengineV1beta4::Module] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::AppengineV1beta4::Module]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def get_app_module(apps_id, modules_id, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::AppengineV1beta4::Module::Representation
          command.response_class = GoogleAPI::Apis::AppengineV1beta4::Module
          command.params['appsId'] = apps_id unless apps_id.nil?
          command.params['modulesId'] = modules_id unless modules_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::AppengineV1beta4::ListModulesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::AppengineV1beta4::ListModulesResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_app_modules(apps_id, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::AppengineV1beta4::ListModulesResponse::Representation
          command.response_class = GoogleAPI::Apis::AppengineV1beta4::ListModulesResponse
          command.params['appsId'] = apps_id unless apps_id.nil?
        ...
        # @param [String] modules_id
        #   Part of `name`. See documentation of `appsId`.
        # @param [GoogleAPI::Apis::AppengineV1beta4::Module] module_object
        # @param [String] mask
        ...
        def patch_app_module(apps_id, modules_id, module_object = nil, mask: nil, migrate_traffic: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::AppengineV1beta4::Module::Representation
        ...
        # @param [String] modules_id
        #   Part of `name`. See documentation of `appsId`.
        # @param [GoogleAPI::Apis::AppengineV1beta4::Version] version_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def create_app_module_version(apps_id, modules_id, version_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::AppengineV1beta4::Version::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::AppengineV1beta4::Version] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::AppengineV1beta4::Version]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def get_app_module_version(apps_id, modules_id, versions_id, view: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::AppengineV1beta4::Version::Representation
          command.response_class = GoogleAPI::Apis::AppengineV1beta4::Version
          command.params['appsId'] = apps_id unless apps_id.nil?
          command.params['modulesId'] = modules_id unless modules_id.nil?
          command.params['versionsId'] = versions_id unless versions_id.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::AppengineV1beta4::ListVersionsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::AppengineV1beta4::ListVersionsResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_app_module_versions(apps_id, modules_id, view: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::AppengineV1beta4::ListVersionsResponse::Representation
          command.response_class = GoogleAPI::Apis::AppengineV1beta4::ListVersionsResponse
          command.params['appsId'] = apps_id unless apps_id.nil?
          command.params['modulesId'] = modules_id unless modules_id.nil?
          command.query['view'] = view unless view.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::AppengineV1beta4::ListOperationsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::AppengineV1beta4::ListOperationsResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_app_operations(apps_id, filter: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::AppengineV1beta4::ListOperationsResponse::Representation
          command.response_class = GoogleAPI::Apis::AppengineV1beta4::ListOperationsResponse
          command.params['appsId'] = apps_id unless apps_id.nil?
