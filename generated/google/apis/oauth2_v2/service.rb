...
module GoogleAPI
  module Apis
    module Oauth2V2
      ...
      #
      #    Oauth2 = GoogleAPI::Apis::Oauth2V2 # Alias the module
      #    service = Oauth2::Oauth2Service.new
      #
      # @see https://developers.google.com/accounts/docs/OAuth2
      class Oauth2Service < GoogleAPI::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [GoogleAPI::Apis::Oauth2V2::Jwk] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::Oauth2V2::Jwk]
        #
        ...
        def get_cert_for_open_id_connect(fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::Oauth2V2::Jwk::Representation
          command.response_class = GoogleAPI::Apis::Oauth2V2::Jwk
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::Oauth2V2::Tokeninfo] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::Oauth2V2::Tokeninfo]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def tokeninfo(access_token: nil, id_token: nil, token_handle: nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::Oauth2V2::Tokeninfo::Representation
          command.response_class = GoogleAPI::Apis::Oauth2V2::Tokeninfo
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::Oauth2V2::Userinfoplus] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::Oauth2V2::Userinfoplus]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def get_userinfo(fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::Oauth2V2::Userinfoplus::Representation
          command.response_class = GoogleAPI::Apis::Oauth2V2::Userinfoplus
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
          execute_or_queue_command(command, &block)
