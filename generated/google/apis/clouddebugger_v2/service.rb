...
module GoogleAPI
  module Apis
    module ClouddebuggerV2
      ...
      #
      #    Clouddebugger = GoogleAPI::Apis::ClouddebuggerV2 # Alias the module
      #    service = Clouddebugger::CloudDebuggerService.new
      #
      # @see https://cloud.google.com/tools/cloud-debugger
      class CloudDebuggerService < GoogleAPI::Apis::Core::BaseService
        # @return [String]
        ...
        # @param [GoogleAPI::Apis::ClouddebuggerV2::RegisterDebuggeeRequest] register_debuggee_request_object
        # @param [String] fields
        ...
        # @yieldparam result [GoogleAPI::Apis::ClouddebuggerV2::RegisterDebuggeeResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::ClouddebuggerV2::RegisterDebuggeeResponse]
        #
        ...
        def register_debuggee(register_debuggee_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::ClouddebuggerV2::RegisterDebuggeeRequest::Representation
          command.request_object = register_debuggee_request_object
          command.response_representation = GoogleAPI::Apis::ClouddebuggerV2::RegisterDebuggeeResponse::Representation
          command.response_class = GoogleAPI::Apis::ClouddebuggerV2::RegisterDebuggeeResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::ClouddebuggerV2::ListActiveBreakpointsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::ClouddebuggerV2::ListActiveBreakpointsResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_controller_debuggee_breakpoints(debuggee_id, wait_token: nil, success_on_timeout: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::ClouddebuggerV2::ListActiveBreakpointsResponse::Representation
          command.response_class = GoogleAPI::Apis::ClouddebuggerV2::ListActiveBreakpointsResponse
        ...
        # @param [GoogleAPI::Apis::ClouddebuggerV2::UpdateActiveBreakpointRequest] update_active_breakpoint_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::ClouddebuggerV2::UpdateActiveBreakpointResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::ClouddebuggerV2::UpdateActiveBreakpointResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def update_active_breakpoint(debuggee_id, id, update_active_breakpoint_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::ClouddebuggerV2::UpdateActiveBreakpointRequest::Representation
          command.request_object = update_active_breakpoint_request_object
          command.response_representation = GoogleAPI::Apis::ClouddebuggerV2::UpdateActiveBreakpointResponse::Representation
          command.response_class = GoogleAPI::Apis::ClouddebuggerV2::UpdateActiveBreakpointResponse
          command.params['debuggeeId'] = debuggee_id unless debuggee_id.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::ClouddebuggerV2::ListDebuggeesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::ClouddebuggerV2::ListDebuggeesResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_debugger_debuggees(project: nil, include_inactive: nil, client_version: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::ClouddebuggerV2::ListDebuggeesResponse::Representation
          command.response_class = GoogleAPI::Apis::ClouddebuggerV2::ListDebuggeesResponse
        ...
        # @param [GoogleAPI::Apis::ClouddebuggerV2::Breakpoint] breakpoint_object
        # @param [String] client_version
        #   The client version making the call. Following: `domain/type/version` (e.g., `
        #   google.com/intellij/v1`).
        # @param [String] fields
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::ClouddebuggerV2::SetBreakpointResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::ClouddebuggerV2::SetBreakpointResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def set_debugger_debuggee_breakpoint(debuggee_id, breakpoint_object = nil, client_version: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::ClouddebuggerV2::Breakpoint::Representation
          command.request_object = breakpoint_object
          command.response_representation = GoogleAPI::Apis::ClouddebuggerV2::SetBreakpointResponse::Representation
          command.response_class = GoogleAPI::Apis::ClouddebuggerV2::SetBreakpointResponse
          command.params['debuggeeId'] = debuggee_id unless debuggee_id.nil?
          command.query['clientVersion'] = client_version unless client_version.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::ClouddebuggerV2::GetBreakpointResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::ClouddebuggerV2::GetBreakpointResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def get_debugger_debuggee_breakpoint(debuggee_id, breakpoint_id, client_version: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::ClouddebuggerV2::GetBreakpointResponse::Representation
          command.response_class = GoogleAPI::Apis::ClouddebuggerV2::GetBreakpointResponse
          command.params['debuggeeId'] = debuggee_id unless debuggee_id.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::ClouddebuggerV2::Empty] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::ClouddebuggerV2::Empty]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def delete_debugger_debuggee_breakpoint(debuggee_id, breakpoint_id, client_version: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::ClouddebuggerV2::Empty::Representation
          command.response_class = GoogleAPI::Apis::ClouddebuggerV2::Empty
          command.params['debuggeeId'] = debuggee_id unless debuggee_id.nil?
          command.params['breakpointId'] = breakpoint_id unless breakpoint_id.nil?
          command.query['clientVersion'] = client_version unless client_version.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::ClouddebuggerV2::ListBreakpointsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::ClouddebuggerV2::ListBreakpointsResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_debugger_debuggee_breakpoints(debuggee_id, include_all_users: nil, include_inactive: nil, action_value: nil, strip_results: nil, wait_token: nil, client_version: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::ClouddebuggerV2::ListBreakpointsResponse::Representation
          command.response_class = GoogleAPI::Apis::ClouddebuggerV2::ListBreakpointsResponse
          command.params['debuggeeId'] = debuggee_id unless debuggee_id.nil?
