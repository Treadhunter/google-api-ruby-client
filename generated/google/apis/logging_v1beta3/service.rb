...
module GoogleAPI
  module Apis
    module LoggingV1beta3
      ...
      #
      #    Logging = GoogleAPI::Apis::LoggingV1beta3 # Alias the module
      #    service = Logging::LoggingService.new
      #
      # @see https://cloud.google.com/logging/docs/
      class LoggingService < GoogleAPI::Apis::Core::BaseService
        # @return [String]
        ...
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::ListLogsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::ListLogsResponse]
        #
        ...
        def list_logs(projects_id, service_name: nil, service_index_prefix: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::ListLogsResponse::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::ListLogsResponse
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::Empty] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::Empty]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def delete_log(projects_id, logs_id, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::Empty::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::Empty
          command.params['projectsId'] = projects_id unless projects_id.nil?
        ...
        # @param [String] logs_id
        #   Part of `logName`. See documentation of `projectsId`.
        # @param [GoogleAPI::Apis::LoggingV1beta3::WriteLogEntriesRequest] write_log_entries_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::WriteLogEntriesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::WriteLogEntriesResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def write_log_entries(projects_id, logs_id, write_log_entries_request_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::LoggingV1beta3::WriteLogEntriesRequest::Representation
          command.request_object = write_log_entries_request_object
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::WriteLogEntriesResponse::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::WriteLogEntriesResponse
          command.params['projectsId'] = projects_id unless projects_id.nil?
          command.params['logsId'] = logs_id unless logs_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::ListLogSinksResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::ListLogSinksResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_log_sinks(projects_id, logs_id, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::ListLogSinksResponse::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::ListLogSinksResponse
          command.params['projectsId'] = projects_id unless projects_id.nil?
          command.params['logsId'] = logs_id unless logs_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::LogSink] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::LogSink]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def get_log_sink(projects_id, logs_id, sinks_id, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::LogSink::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::LogSink
          command.params['projectsId'] = projects_id unless projects_id.nil?
          command.params['logsId'] = logs_id unless logs_id.nil?
        ...
        # @param [String] logs_id
        #   Part of `logName`. See documentation of `projectsId`.
        # @param [GoogleAPI::Apis::LoggingV1beta3::LogSink] log_sink_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def create_log_sink(projects_id, logs_id, log_sink_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::LoggingV1beta3::LogSink::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::ListLogServicesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::ListLogServicesResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_log_services(projects_id, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::ListLogServicesResponse::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::ListLogServicesResponse
          command.params['projectsId'] = projects_id unless projects_id.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::ListLogServiceIndexesResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::ListLogServiceIndexesResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_log_service_indexes(projects_id, log_services_id, index_prefix: nil, depth: nil, page_size: nil, page_token: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::ListLogServiceIndexesResponse::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::ListLogServiceIndexesResponse
          command.params['projectsId'] = projects_id unless projects_id.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::ListLogServiceSinksResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::ListLogServiceSinksResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_log_service_sinks(projects_id, log_services_id, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::ListLogServiceSinksResponse::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::ListLogServiceSinksResponse
          command.params['projectsId'] = projects_id unless projects_id.nil?
          command.params['logServicesId'] = log_services_id unless log_services_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::ListSinksResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::ListSinksResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_project_sinks(projects_id, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::ListSinksResponse::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::ListSinksResponse
          command.params['projectsId'] = projects_id unless projects_id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          execute_or_queue_command(command, &block)
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::ListLogMetricsResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::ListLogMetricsResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_project_metrics(projects_id, page_token: nil, page_size: nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::ListLogMetricsResponse::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::ListLogMetricsResponse
          command.params['projectsId'] = projects_id unless projects_id.nil?
          command.query['pageToken'] = page_token unless page_token.nil?
          command.query['pageSize'] = page_size unless page_size.nil?
          command.query['fields'] = fields unless fields.nil?
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::LoggingV1beta3::LogMetric] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::LoggingV1beta3::LogMetric]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def get_project_metric(projects_id, metrics_id, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::LoggingV1beta3::LogMetric::Representation
          command.response_class = GoogleAPI::Apis::LoggingV1beta3::LogMetric
          command.params['projectsId'] = projects_id unless projects_id.nil?
        ...
        #   metric.
        # @param [GoogleAPI::Apis::LoggingV1beta3::LogMetric] log_metric_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def create_project_metric(projects_id, log_metric_object = nil, fields: nil, quota_user: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::LoggingV1beta3::LogMetric::Representation
