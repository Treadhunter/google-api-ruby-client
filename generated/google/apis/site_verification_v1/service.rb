...
module GoogleAPI
  module Apis
    module SiteVerificationV1
      ...
      #
      #    SiteVerification = GoogleAPI::Apis::SiteVerificationV1 # Alias the module
      #    service = SiteVerification::SiteVerificationService.new
      #
      # @see https://developers.google.com/site-verification/
      class SiteVerificationService < GoogleAPI::Apis::Core::BaseService
        # @return [String]
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::SiteVerificationV1::SiteVerificationWebResourceResource] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::SiteVerificationV1::SiteVerificationWebResourceResource]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def get_web_resource(id, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::SiteVerificationV1::SiteVerificationWebResourceResource::Representation
          command.response_class = GoogleAPI::Apis::SiteVerificationV1::SiteVerificationWebResourceResource
          command.params['id'] = id unless id.nil?
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
        ...
        # @param [GoogleAPI::Apis::SiteVerificationV1::GetWebResourceTokenRequest] get_web_resource_token_request_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::SiteVerificationV1::GetWebResourceTokenResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::SiteVerificationV1::GetWebResourceTokenResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def get_web_resource_token(get_web_resource_token_request_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::SiteVerificationV1::GetWebResourceTokenRequest::Representation
          command.request_object = get_web_resource_token_request_object
          command.response_representation = GoogleAPI::Apis::SiteVerificationV1::GetWebResourceTokenResponse::Representation
          command.response_class = GoogleAPI::Apis::SiteVerificationV1::GetWebResourceTokenResponse
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
          execute_or_queue_command(command, &block)
        ...
        # @param [GoogleAPI::Apis::SiteVerificationV1::SiteVerificationWebResourceResource] site_verification_web_resource_resource_object
        # @param [String] fields
        #   Selector specifying which fields to include in a partial response.
        # @param [String] quota_user
        #   Available to use for quota purposes for server-side applications. Can be any
        ...
        def insert_web_resource(verification_method, site_verification_web_resource_resource_object = nil, fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.request_representation = GoogleAPI::Apis::SiteVerificationV1::SiteVerificationWebResourceResource::Representation
        ...
        #
        # @yield [result, err] Result & error if block supplied
        # @yieldparam result [GoogleAPI::Apis::SiteVerificationV1::ListWebResourceResponse] parsed result object
        # @yieldparam err [StandardError] error object if request failed
        #
        # @return [GoogleAPI::Apis::SiteVerificationV1::ListWebResourceResponse]
        #
        # @raise [GoogleAPI::Apis::ServerError] An error occurred on the server and the request can be retried
        # @raise [GoogleAPI::Apis::ClientError] The request is invalid and should not be retried without modification
        # @raise [GoogleAPI::Apis::AuthorizationError] Authorization is required
        def list_web_resources(fields: nil, quota_user: nil, user_ip: nil, options: nil, &block)
          ...
          command.response_representation = GoogleAPI::Apis::SiteVerificationV1::ListWebResourceResponse::Representation
          command.response_class = GoogleAPI::Apis::SiteVerificationV1::ListWebResourceResponse
          command.query['fields'] = fields unless fields.nil?
          command.query['quotaUser'] = quota_user unless quota_user.nil?
          command.query['userIp'] = user_ip unless user_ip.nil?
          execute_or_queue_command(command, &block)
